...
SET KPT_KETTLE_PARAM_Config_CDC_Source_Transformation_Path=from-canal
SET KPT_KETTLE_PARAM_Config_CDC_Source_Table_Mapping=canal_table
...
SET KPT_CALLER_SCRIPT_PATH=%project_folder_path%test.%KPT_KETTLE_PARAM_Config_CDC_Source_Transformation_Path%.%KPT_KETTLE_PARAM_Config_CDC_Source_Table_Mapping%.bat
