...
SET KPT_KETTLE_PARAM_Param_Input_Json_File=../schema_formatter.test/connect_json/test_debezium_mysql-test_kpt_cdc-reroute.data-changes.json
SET KPT_KETTLE_PARAM_Config_CDC_Source_Transformation_Path=from_debezium
SET KPT_KETTLE_PARAM_Config_CDC_Source_Row_Mapping=mysql_payload
...
SET KPT_KETTLE_PARAM_Param_Group_Transformation=group_to_file.result
@REM group_to_file.result param
SET KPT_KETTLE_PARAM_Param_Output_Name=connect_json
