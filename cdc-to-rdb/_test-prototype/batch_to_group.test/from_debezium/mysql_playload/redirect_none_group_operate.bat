...
SET KPT_KETTLE_PARAM_Param_Input_Json_File=from_debezium/mysql_payload.json
...
SET KPT_KETTLE_PARAM_Config_CDC_Batch_Group_Table_Mapping=sort_by_table_timestamp
...
SET KPT_CALLER_SCRIPT_PATH=%project_folder_path%test.batch_to_group.mysql_payload.redirect_none_group_operate.bat
