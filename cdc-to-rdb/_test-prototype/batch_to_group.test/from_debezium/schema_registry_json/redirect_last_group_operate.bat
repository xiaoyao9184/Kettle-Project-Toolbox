...
SET KPT_KETTLE_PARAM_Param_Input_Json_File=../schema_formatter.test/schema_registry_avro/test_debezium_mysql-test_kpt_cdc-json.data-changes.json
...
SET KPT_KETTLE_PARAM_Param_Output_Name=schema_registry_json
