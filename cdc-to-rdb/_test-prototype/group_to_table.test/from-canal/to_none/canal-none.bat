...
SET KPT_KETTLE_PARAM_Config_Log_Source_Column_Mapping=canal_sqltype
SET KPT_KETTLE_PARAM_Config_Log_Source_Key_Mapping=canal_pknames
...
SET KPT_KETTLE_PARAM_Param_Group_Name=from_canal.to_none
