...
SET KPT_KETTLE_PARAM_Config_Log_Source_Column_Mapping=mssql_schema
...
SET KPT_KETTLE_PARAM_Param_Group_Name=from_debezium.mssql_schema.to_none.config_prefix_lookup
...
@REM for protptype
SET KPT_KETTLE_PARAM_Config_Log_Target_Schema_Prefix=mssql_manual_generation__
