...
SET KPT_KETTLE_PARAM_Param_Group_Name=debezium-mysql-operate-update
...
@REM for protptype
SET KPT_KETTLE_PARAM_Config_Log_UpdateOnly_FlashPoint_Include=INSERT,SNAPSHOT
SET KPT_KETTLE_PARAM_Config_Log_UpdateOnly_FlashPoint_Timestamp=2022-01-01T00:00:00.000Z
