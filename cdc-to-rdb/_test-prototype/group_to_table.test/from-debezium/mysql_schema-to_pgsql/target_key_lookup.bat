...
SET KPT_KETTLE_PARAM_Config_CDC_Target_Key_Mapping=target_key_lookup
SET KPT_KETTLE_PARAM_Config_CDC_Target_Operate_Mapping=same_source
SET KPT_KETTLE_PARAM_Config_CDC_Target_Table_Mapping=config_prefix_lookup
...
@REM for protptype
SET KPT_KETTLE_PARAM_Config_CDC_Target_Schema_Prefix=mysql_manual_generation__
SET KPT_KETTLE_PARAM_Config_CDC_Target_Table_Prefix=change_pk__
...
SET KPT_KETTLE_PARAM_Config_CDC_Target_Case_Sensitive=true
