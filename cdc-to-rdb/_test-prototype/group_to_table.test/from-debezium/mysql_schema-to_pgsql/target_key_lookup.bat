...
SET KPT_KETTLE_PARAM_Config_DB_db___kpt___cdc___event___pgsql___writer___database=test_kpt
SET KPT_KETTLE_PARAM_Config_DB_db___kpt___cdc___event___pgsql___writer___password=kpt.123
SET KPT_KETTLE_PARAM_Config_DB_db___kpt___cdc___event___pgsql___writer___port=55432
SET KPT_KETTLE_PARAM_Config_DB_db___kpt___cdc___event___pgsql___writer___server=pgsql
SET KPT_KETTLE_PARAM_Config_DB_db___kpt___cdc___event___pgsql___writer___username=kpt
SET KPT_KETTLE_PARAM_Config_Log_Target_Case_Sensitive=true
