...
SET KPT_KETTLE_PARAM_Config_Log_Source_Column_Mapping=mysql_schema
...
SET KPT_KETTLE_PARAM_Config_Log_Target_Key_Mapping=target_key_lookup
SET KPT_KETTLE_PARAM_Config_Log_Target_Operate_Mapping=same_source
SET KPT_KETTLE_PARAM_Config_Log_Target_Table_Mapping=config_prefix_lookup
SET KPT_KETTLE_PARAM_Config_Log_Target_Transformation_Path=to_pgsql
SET KPT_KETTLE_PARAM_Param_Group_ID=test
SET KPT_KETTLE_PARAM_Param_Group_Name=from_debezium.mysql_schema.to_pgsql.target_key_lookup
...
SET KPT_KETTLE_PARAM_ParamTemplateTransformation=message_convert_to_rdb_rud.template

@REM for protptype
SET KPT_KETTLE_PARAM_Config_Log_Target_Schema_Prefix=mysql_manual_generation__
SET KPT_KETTLE_PARAM_Config_Log_Target_Table_Prefix=change_pk__
SET KPT_KETTLE_PARAM_Config_DB_db_kpt_cdc_event_pgsql_writer_database=test_kpt
SET KPT_KETTLE_PARAM_Config_DB_db_kpt_cdc_event_pgsql_writer_password=kpt.123
SET KPT_KETTLE_PARAM_Config_DB_db_kpt_cdc_event_pgsql_writer_port=55432
SET KPT_KETTLE_PARAM_Config_DB_db_kpt_cdc_event_pgsql_writer_server=pgsql
SET KPT_KETTLE_PARAM_Config_DB_db_kpt_cdc_event_pgsql_writer_username=kpt
SET KPT_KETTLE_PARAM_Config.Log.Target.Case.Sensitive=true
