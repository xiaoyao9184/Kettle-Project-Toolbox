...
SET KPT_KETTLE_PARAM_Param_Input_Json_File=from_canal/canal_sqltype.json
...
SET KPT_KETTLE_PARAM_Config_CDC_Source_Column_Mapping=canal_sqltype
SET KPT_KETTLE_PARAM_Config_CDC_Source_Key_Mapping=canal_pknames
...
SET KPT_KETTLE_PARAM_Param_Group_Name=from_canal.to_none.canal-none
...
SET KPT_CALLER_SCRIPT_PATH=%project_folder_path%test.group_to_table.from_canal.to_none.canal-none.bat
