...
SET KPT_KETTLE_PARAM_Param_Input_Json_File=../group_to_file.result/connect_json.0.0.group.json
...
SET KPT_KETTLE_PARAM_Param_Group_Name=from_debezium.connect_json.0.0.to_none.same_source_exist
...
SET KPT_CALLER_SCRIPT_PATH=%project_folder_path%test.group_to_table.from_debezium.connect_json.0.0-to_none.same_source_exist.bat
