...
SET KPT_KETTLE_PARAM_Param_Input_Json_File=from_debezium/mssql_schema.json
...
SET KPT_KETTLE_PARAM_Param_Group_Name=from_debezium.mssql_schema.to_none.config_prefix_exist
...
@REM config_prefix_exist param
SET KPT_KETTLE_PARAM_Config_CDC_Target_Table_Prefix_Table_Schema=mssql_manual_generation__
SET KPT_KETTLE_PARAM_Config_CDC_Target_Table_Prefix_Table=change_pk__


SET KPT_CALLER_SCRIPT_PATH=%project_folder_path%test.group_to_table.from_debezium.mssql_schema-to_none.config_prefix_exist.bat
