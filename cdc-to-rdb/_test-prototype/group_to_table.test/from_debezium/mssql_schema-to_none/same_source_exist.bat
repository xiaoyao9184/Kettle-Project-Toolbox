...
SET KPT_KETTLE_PARAM_Param_Group_Name=from_debezium.mssql_schema.to_none.same_source_exist
...
SET KPT_CALLER_SCRIPT_PATH=%project_folder_path%test.group_to_table.from_debezium.mssql_schema-to_none.same_source_exist.bat
