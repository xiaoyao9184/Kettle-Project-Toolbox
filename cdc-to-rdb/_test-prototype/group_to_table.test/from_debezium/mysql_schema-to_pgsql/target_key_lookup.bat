...
SET KPT_KETTLE_PARAM_Param_Input_Json_File=from_debezium/mysql_schema.json
...
SET KPT_CALLER_SCRIPT_PATH=%project_folder_path%test.group_to_table.from_debezium.mysql_schema-to_pgsql.target_key_lookup.bat
