...
SET KPT_KETTLE_PARAM_Param_Group_Name=from_debezium.schema_registry_json.0.0.to_none.same_source_exist
...
SET KPT_KETTLE_PARAM_ParamJsonFile=../group_to_file.result/schema_registry_json.0.0.group.json


SET KPT_CALLER_SCRIPT_PATH=%project_folder_path%test.group_to_table.from_debezium.schema_registry_json.0.0-to_none.same_source_exist.bat
