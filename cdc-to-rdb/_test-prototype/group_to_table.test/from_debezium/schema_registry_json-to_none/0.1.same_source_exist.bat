...
SET KPT_KETTLE_PARAM_Config_CDC_Kafka_Data_Format=schema_registry_json
SET KPT_KETTLE_PARAM_Param_Batch_ID=test
SET KPT_KETTLE_PARAM_Param_Group_ID=injection
SET KPT_KETTLE_PARAM_Param_Group_Name=from_debezium.schema_registry_json.0.1.to_none.same_source_exist
...
SET KPT_KETTLE_PARAM_ParamJsonFile=../group_to_file.result/schema_registry_json.0.1.group.json


SET KPT_CALLER_SCRIPT_PATH=%project_folder_path%test.group_to_table.from_debezium.schema_registry_json.0.1-to_none.same_source_exist.bat
