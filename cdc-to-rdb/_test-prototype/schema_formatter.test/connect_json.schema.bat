...
SET KPT_KETTLE_PARAM_Config_CDC_Batch_Schema_Format_Mapping=connect_json
@REM connect_json param
@REM SET KPT_KETTLE_PARAM_Config_CDC_Batch_Schema_Registry_Url=http://me:58081
