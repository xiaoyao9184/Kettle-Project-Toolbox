...
ENDLOCAL & (
    ...
    SET copy_item_name_list=config.xml;db_kpt_cdc_rdb_writer.kdb;.kettle\kettle.properties
    SET link_item_name_list=.pdi;from_canal;from_debezium;from_kafka;to_none;to_pgsql;to_rdb;_test-config;_test-container;_test-prototype
