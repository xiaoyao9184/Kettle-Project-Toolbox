...
::version
SET tip=Kettle-Project-Toolbox: package path
SET ver=1.0
...
::tip info
SET tip_source_path_input=Need input 'source_path' or drag path in:
SET tip_source_path_miss=Missing param 'source_path' at position 1.
SET tip_source_path_wrong=Wrong param 'source_path' at position 1.
...
SET KPT_KETTLE_FILE=%current_script_dir%Deploy\PackageZipDeploy4Path.kjb
SET KPT_KETTLE_PARAM_srcPath=%source_path%
